...
import com.inforica.booker.views.viewpager.CirclePageIndicator;
import com.inforica.booker.views.viewpager.PageIndicator;

/**
 * Created by user on 4/19/2016.
 */
public class StartUpPageInstructions extends SuperActivity {
            ...
            if (focusedPage == 2) {
                ...
                child_frame_LinearLayout.setVisibility(View.GONE);
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i = new Intent(StartUpPageInstructions.this, LoginScreen.class);
